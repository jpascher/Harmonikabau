...
\newcommand{\hbtitel}{Diskant-Stimmstock — Kammerfrequenzen D3–C6}
\newcommand{\hbuntertitel}{Sieben Varianten mit praktischer Tiefenbeschränkung}
\newcommand{\hbheadtext}{Dok.\,0007 --- Diskant-Stimmstock: Kammerfrequenzen D3--C6}
\newcommand{\hbfoottext}{7 Varianten: A (Ref.) / B,C,Ci (Tiefe) / D,E,Ei (\"{O}ffnung)}
