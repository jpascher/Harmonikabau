...
\newcommand{\hbtitel}{Zeichenerklärung}
\newcommand{\hbuntertitel}{Formelzeichen und Einheiten der Harmonikabau-Reihe}
\newcommand{\hbheadtext}{Dok.\,0006 --- Zeichenerkl\"{a}rung}
\newcommand{\hbfoottext}{Harmonikabau-Reihe}
