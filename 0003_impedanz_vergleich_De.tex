...
\newcommand{\hbtitel}{Impedanzvergleich}
\newcommand{\hbuntertitel}{Durchschlagzunge vs.\ Labialpfeife}
\newcommand{\hbheadtext}{Dok.\,0003 --- Impedanzvergleich: Durchschlagzunge vs.\ Labialpfeife}
\newcommand{\hbfoottext}{Querverweise: Dok.\,0002 $\cdot$ Dok.\,0004}
...
Der Jet am Labium ist ein \textbf{Geschwindigkeitsgenerator} (hohe Schnelle, niedrige Impedanz). Er „sieht" das Rohr als Last. Die Schwingung entsteht dort, wo die \textbf{Rohrimpedanz maximal} ist -- weil dort die größte Druckrückkopplung auf den Jet wirkt. Der Jet passt sich der Rohrlänge an.
...
Hier liegt der fundamentale Unterschied. Der Spalt zwischen Zunge und Stimmplatte verwandelt die mechanische Impedanz der Zunge in eine \textbf{akustische Impedanz}, die die Kammer „sieht":
\begin{equation}
...
Für den Instrumentenbauer: \textbf{Die Kammer ist kein Resonanzkörper}, sondern ein \textbf{Impedanz-Umfeld}, das die Zunge „sieht" und deren Frequenz mitbestimmt. Die Optimierung zielt auf Phasenverträglichkeit (Dok.\,0002 Kap.\,11--12) und minimale Frequenzziehung (Dok.\,0004 Kap.\,5).
\end{keybox}
