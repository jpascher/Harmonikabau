...
\newcommand{\hbtitel}{Klangveränderung durch Kammergeometrie}
\newcommand{\hbuntertitel}{Die Kammer als Kerbfilter im Obertonspektrum}
\newcommand{\hbheadtext}{Dok.\,0008 --- Klangver\"{a}nderung durch Kammergeometrie}
\newcommand{\hbfoottext}{Querverweise: Dok.\,0002 $\cdot$ Dok.\,0005 $\cdot$ Dok.\,0007}
...
\toprule
\textbf{Betroffener OT} & \textbf{Frequenz-bereich} & \textbf{Klangeffekt} \\
\midrule
...
\toprule
& $Q_\text{rad}$ & $Q_\text{visc}$ & $Q_\text{tot}$ & Dominanter Verlust \\
\midrule
