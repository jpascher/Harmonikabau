...
\newcommand{\hbtitel}{Leitfaden zur ästhetischen Forensik}
\newcommand{\hbuntertitel}{bei Akkordeon-Gehäusen}
\newcommand{\hbheadtext}{Dok.\,0500 --- \"{A}sthetische Forensik: Akkordeon-Geh\"{a}use}
\newcommand{\hbfoottext}{Harmonikabau}
